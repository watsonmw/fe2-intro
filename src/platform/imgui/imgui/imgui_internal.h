...
// Transient per-window data, reset at the beginning of the frame. This used to be called ImGuiraster, hence the DC variable name in ImGuiWindow.
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImGuiWindowTempData     DC;                                 // Temporary per-window data, reset at the beginning of the frame. This used to be called ImGuiraster, hence the "DC" variable name.
